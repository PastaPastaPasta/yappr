...
function QuotedPostContainer({ children }: { children: React.ReactNode }) {
  return (
    <div className="mt-4 border border-surface-200 dark:border-neutral-750 rounded-xl p-3 bg-gray-50 dark:bg-surface-950">
      {children}
    </div>
  )
}
...
export function ReplyContext({ author }: ReplyContextProps) {
  ...
  return (
    <div className="px-4 py-3 bg-gray-50 dark:bg-surface-950 border-b border-surface-200 dark:border-neutral-750">
      <div className="flex items-center gap-2 text-sm">
