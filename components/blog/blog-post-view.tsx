      ...
      <div className="relative">
        ...
        <article className="mx-auto max-w-[680px]">
          ...
          <div className="mt-4 flex items-center gap-3">
            {blog.avatar ? (
              ...
              <UserAvatar userId={blog.ownerId} alt={blog.name} size="md" className="shrink-0" />
            )}
          ...
          {showFollowCta && (
            <div className="mt-8 flex items-center gap-3 rounded-xl border p-4" style={{ borderColor: 'var(--blog-border)', backgroundColor: 'var(--blog-surface)' }}>
              {blog.avatar ? (
                ...
                <UserAvatar userId={blog.ownerId} alt={blog.name} size="sm" />
              )}
        ...
        <aside className="absolute left-[calc(50%+370px)] top-0 hidden xl:block">
          <div className="sticky top-24 flex flex-col items-center gap-4">
            <button
              type="button"
              className="group rounded-full p-2 transition hover:bg-black/5 dark:hover:bg-white/10"
              aria-label="Like"
            >
            ...
            <button
              ...
              onClick={handleShareX}
            >
              <svg className="h-5 w-5 text-gray-400 transition group-hover:text-gray-700 dark:group-hover:text-white" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
            </button>
          </div>
        </aside>
      </div>
