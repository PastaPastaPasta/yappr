        ...
        <CardContent>
          <div className="space-y-3">
            {[1, 2, 3].map((i) => (
              <div
                key={i}
                className="flex items-center justify-between p-3 bg-surface-50 dark:bg-surface-950 rounded-lg"
              >
  ...
  if (!hasPrivateFeed) {
    return (
      <Card>
        ...
        <CardContent>
          <div className="bg-surface-50 dark:bg-surface-900 p-4 rounded-lg text-center">
