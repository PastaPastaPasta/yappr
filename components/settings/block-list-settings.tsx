  ...
  return (
    <div className="space-y-4">
      ...
      {followedUsers.length === 0 ? (
        ...
        <>
          <div className="space-y-1 divide-y divide-gray-200 dark:divide-gray-800 border border-surface-200 dark:border-neutral-750 rounded-lg overflow-hidden">
            {followedUsers.map(followedUser => (
              <div
                key={followedUser.id}
                className="flex items-center justify-between p-3 bg-white dark:bg-surface-900 hover:bg-gray-50 dark:hover:bg-gray-950 transition-colors"
              >
                <Link
