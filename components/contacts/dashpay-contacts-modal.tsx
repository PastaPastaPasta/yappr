    ...
    <Dialog.Root open={isOpen} onOpenChange={handleClose}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-surface-900 rounded-2xl p-0 w-[500px] max-w-[90vw] max-h-[600px] shadow-xl z-50 flex flex-col">
          {/* Header */}
          <div className="sticky top-0 bg-white dark:bg-surface-900 border-b border-surface-200 dark:border-surface-800 px-4 py-3 flex items-center justify-between rounded-t-2xl">
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            >
              {/* Stats bar */}
              {contacts.length > 0 && (
                <div className="px-4 py-3 bg-surface-50 dark:bg-neutral-800 border-b border-surface-200 dark:border-surface-700">
          ...
          {(state === 'ready' || state === 'following') && contacts.length > 1 && (
            <div className="sticky bottom-0 bg-white dark:bg-surface-900 border-t border-surface-200 dark:border-surface-800 px-4 py-3 rounded-b-2xl">
              <Button
...
function ContactRow({
  ...
  return (
    <div className="p-4 hover:bg-surface-50 dark:hover:bg-surface-950 transition-colors">
