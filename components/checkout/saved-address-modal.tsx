...
export function SavedAddressModal({
  ...
  const renderList = () => (
    <>
      <div className="p-4 space-y-3 max-h-96 overflow-y-auto">
        {addresses.length === 0 ? (
          ...
          addresses.map((address) => (
            <div
              key={address.id}
              className="p-3 rounded-lg border border-surface-200 dark:border-neutral-750 hover:border-gray-300 dark:hover:border-gray-600 transition-colors"
            >
      ...
      <div className="flex items-center justify-between px-4 py-3 border-t border-surface-200 dark:border-neutral-750 bg-gray-50 dark:bg-surface-950">
      ...
      <div className="p-4 space-y-4 max-h-[60vh] overflow-y-auto">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2 border border-surface-200 dark:border-neutral-750 rounded-lg bg-white dark:bg-surface-900 focus:outline-none focus:ring-2 focus:ring-yappr-500"
          />
        </div>

        <div className="border-t border-surface-200 dark:border-neutral-750 pt-4">
