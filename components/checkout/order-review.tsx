...
export function OrderReview({
  ...
  return (
    <div className="p-4 space-y-4">
      ...
      {/* Store */}
      <div className="p-4 bg-surface-100 dark:bg-surface-800 rounded-lg flex items-center gap-3">
        {store?.logoUrl ? (
          <img src={store.logoUrl} alt={store.name} className="w-10 h-10 rounded-lg object-cover" />
        ) : (
          <div className="w-10 h-10 rounded-lg bg-surface-200 dark:bg-surface-800 flex items-center justify-center">
      ...
      {/* Items */}
      <div className="border border-surface-200 dark:border-neutral-750 rounded-lg divide-y divide-gray-200 dark:divide-gray-800">
        {items.map((item) => (
      ...
      <div className="space-y-2 pt-4">
        ...
        <div className="flex justify-between text-lg font-bold pt-2 border-t border-surface-200 dark:border-neutral-750">
          <span>Total</span>
      ...
      <div>
        ...
        <textarea
          ...
          rows={2}
          className="w-full px-4 py-2 border border-surface-200 dark:border-neutral-750 rounded-lg bg-white dark:bg-surface-900 focus:outline-none focus:ring-2 focus:ring-yappr-500 resize-none"
        />
      </div>
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-4 py-2 border border-surface-200 dark:border-neutral-750 rounded-lg bg-white dark:bg-surface-900 focus:outline-none focus:ring-2 focus:ring-yappr-500 font-mono text-sm"
        />
      </div>
