...
export function SaveAddressPrompt({
  ...
  return (
    <div className="p-4 bg-gray-50 dark:bg-gray-900/50 border-y border-surface-200 dark:border-neutral-750">
      <div className="flex items-start gap-3">
          ...
          <div className="mt-3">
            {!showCustom ? (
              ...
              <input
                ...
                className="w-full px-3 py-2 text-sm border border-surface-200 dark:border-neutral-750 rounded-lg bg-white dark:bg-surface-900 focus:outline-none focus:ring-2 focus:ring-yappr-500"
                autoFocus
              />
            )}
          </div>
