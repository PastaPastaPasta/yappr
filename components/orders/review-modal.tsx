                  ...
                  >
                    ...
                    <div className="p-4 space-y-4">
                      ...
                      <div className="flex items-center gap-3 pb-4 border-b border-surface-100 dark:border-surface-800">
                        <div className="w-12 h-12 rounded-lg bg-surface-100 dark:bg-surface-800 flex items-center justify-center flex-shrink-0">
                          {store.logoUrl ? (
                            <img
                              src={store.logoUrl}
                              alt={store.name}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          disabled={isSubmitting}
                          className="w-full px-3 py-2 rounded-lg border border-surface-200 dark:border-surface-700 bg-transparent focus:outline-none focus:ring-2 focus:ring-yappr-500 disabled:opacity-50"
                        />
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          rows={4}
                          disabled={isSubmitting}
                          className="w-full px-3 py-2 rounded-lg border border-surface-200 dark:border-surface-700 bg-transparent resize-none focus:outline-none focus:ring-2 focus:ring-yappr-500 disabled:opacity-50"
                        />
                        <p className="text-xs text-gray-400 mt-1 text-right">
