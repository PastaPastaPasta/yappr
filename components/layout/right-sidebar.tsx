...
export function RightSidebar() {
  ...
  return (
    <div className="hidden lg:block w-[350px] shrink-0 px-4 py-4 space-y-4 h-[calc(100vh-40px)] sticky top-[40px] overflow-y-auto scrollbar-hide">
      ...
      <div className="bg-surface-1 dark:bg-surface-2 rounded-2xl overflow-hidden border border-border">
        ...
        <div className="px-4 py-3 space-y-3 text-sm">
          ...
          <ul className="space-y-2">
            <li>
              <Link href={user?.identityId ? `/user?id=${user.identityId}&edit=true` : '/settings?section=account'} className="text-yappr-500 hover:text-yappr-400 dark:hover:text-yappr-300 hover:underline transition-colors">
                • Create your profile
              </Link>
            </li>
            <li>
              <Link href="/feed" className="text-yappr-500 hover:text-yappr-400 dark:hover:text-yappr-300 hover:underline transition-colors">
                • Share your first post
              </Link>
            </li>
            <li>
              <Link href="/explore" className="text-yappr-500 hover:text-yappr-400 dark:hover:text-yappr-300 hover:underline transition-colors">
