export function DevelopmentBanner() {
  return (
    <div className="bg-amber-500/90 backdrop-blur-sm text-black px-2 sm:px-4 text-xs sm:text-sm fixed top-0 left-0 right-0 z-50 h-[32px] sm:h-[40px] flex items-center justify-center">
