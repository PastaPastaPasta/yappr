    ...
    return (
      <button
        ...
        className={cn(
          ...
          'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-yappr-500/40',
          'disabled:pointer-events-none disabled:opacity-50',
          'interactive-scale',
          {
            'text-surface-500 dark:text-surface-400 hover:text-gray-900 dark:hover:text-gray-100': variant === 'default',
