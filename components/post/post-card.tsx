      ...
      <div className="flex gap-3">
        ...
        <div className="flex-1 min-w-0">
          ...
          {replyTo && !isTipPost && (
            ...
            >
              Replying to <span className="text-yappr-500">@{replyTo.author.username && !replyTo.author.username.startsWith('user_') ? replyTo.author.username : replyTo.author.displayName}</span>
            </Link>
          )}
