...
export default defineConfig({
  ...
  resolve: {
    alias: [
      ...
      { find: /^@\/lib\/utils\/resolve-user-details$/, replacement: mocks },
      { find: /^@\/components\/ui\/avatar-image$/, replacement: mocks },
      { find: /^next\/link$/, replacement: fromHere('./next-link-mock.ts') },
