...
export default function PublicHomePage() {
  ...
  if (!isHydrated) {
    return (
      <div className="min-h-[calc(100vh-40px)] flex bg-surface-50 dark:bg-surface-950 bg-mesh">
        ...
        <div className="hidden md:block fixed h-[calc(100vh-40px)] w-[275px] px-2 py-4 top-[40px]">
          ...
          <div className="space-y-2">
            {[...Array(6)].map((_, i) => (
              <div key={i} className="h-12 bg-surface-100 dark:bg-surface-800 rounded-full animate-pulse" />
            ))}
          </div>
        ...
        <main className="flex-1 md:max-w-[1200px] mx-auto px-4 md:px-8 py-8 md:py-16">
          <div className="text-center mb-8 md:mb-16">
            ...
            <div className="h-5 md:h-6 w-full max-w-[300px] md:max-w-[500px] bg-surface-100 dark:bg-surface-800 rounded mx-auto mb-6 md:mb-8 animate-pulse" />
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center px-4 sm:px-0">
              <div className="h-12 w-full sm:w-32 bg-surface-200 dark:bg-surface-800 rounded animate-pulse" />
              <div className="h-12 w-full sm:w-32 bg-surface-100 dark:bg-surface-800 rounded animate-pulse" />
            </div>
          </div>
        </main>
      </div>
  ...
  return (
    <div className="min-h-[calc(100vh-40px)] flex bg-surface-50 dark:bg-surface-950 bg-mesh">
      ...
      <main className="flex-1 md:max-w-[1200px] mx-auto px-4 md:px-8 overflow-x-hidden">
        ...
        <section className="py-8 md:py-16 text-center">
          ...
          >
            <h1 className="font-display text-4xl md:text-6xl lg:text-7xl font-bold mb-4">
              Your voice,<br /><span className="text-gradient">truly yours.</span>
            </h1>
            ...
            <p className="text-lg md:text-xl text-gray-500 dark:text-gray-400 mb-6 md:mb-8 max-w-2xl mx-auto px-2">
        ...
        {/* CTA Section */}
        <section className="py-16 text-center border-t border-surface-200 dark:border-neutral-750">
          <h2 className="font-display text-3xl font-bold mb-4">Ready to join the conversation?</h2>
