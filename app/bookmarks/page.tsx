          ...
          <div className="flex items-center justify-between px-4 py-3">
            ...
            <DropdownMenu.Root>
              <DropdownMenu.Trigger asChild>
                <button className="p-2 hover:bg-surface-100 dark:hover:bg-surface-800 rounded-full">
              ...
              <DropdownMenu.Portal>
                <DropdownMenu.Content
                  className="min-w-[200px] bg-white dark:bg-surface-900 rounded-xl shadow-elevated-lg border border-surface-200 dark:border-surface-800 py-2 z-50"
                  sideOffset={5}
                >
                  <DropdownMenu.Item
                    className="px-4 py-2 text-sm hover:bg-surface-100 dark:hover:bg-surface-800 cursor-pointer outline-none flex items-center gap-2"
                  ...
                  <DropdownMenu.Item
                    className="px-4 py-2 text-sm hover:bg-surface-100 dark:hover:bg-surface-800 cursor-pointer outline-none flex items-center gap-2 text-red-600"
            ...
            {filteredBookmarks.map((post) => (
              ...
              >
                ...
                <div className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity">
                  <DropdownMenu.Root>
                    <DropdownMenu.Trigger asChild>
                      <button className={`p-2 bg-white/90 dark:bg-surface-900/90 rounded-full shadow-lg hover:bg-surface-100 dark:hover:bg-surface-800 ${potatoMode ? '' : 'backdrop-blur-sm'}`}>
                        <EllipsisHorizontalIcon className="h-5 w-5" />
                      </button>
                    </DropdownMenu.Trigger>
                    ...
                    <DropdownMenu.Portal>
                      <DropdownMenu.Content
                        className="min-w-[180px] bg-white dark:bg-surface-900 rounded-xl shadow-elevated-lg border border-surface-200 dark:border-surface-800 py-2 z-50"
                        sideOffset={5}
                      >
                        <DropdownMenu.Item
                          className="px-4 py-2 text-sm hover:bg-surface-100 dark:hover:bg-surface-800 cursor-pointer outline-none flex items-center gap-2"
