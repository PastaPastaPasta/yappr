    ...
    <html lang="en" className="h-full" suppressHydrationWarning>
      <head>
        <meta
          ...
          content="default-src 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline' https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com; img-src 'self' data: https: blob:; font-src 'self' https://fonts.gstatic.com; connect-src 'self' https: wss: https://44.240.98.102:1443 https://cloudflareinsights.com; worker-src 'self' blob:; child-src 'self' blob:; media-src 'self' https: blob:; frame-src 'self' blob: https://www.youtube-nocookie.com https://www.youtube.com"
        />
      </head>
