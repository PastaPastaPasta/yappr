...
function SettingsPage() {
    ...
    <div className="divide-y divide-gray-200 dark:divide-gray-800">
      {settingsSections.map((section) => (
        <button
          ...
          className="w-full p-4 hover:bg-surface-50 dark:hover:bg-surface-950 transition-colors flex items-center gap-4"
        >
  ...
  const renderAccountSettings = () => (
    <div className="p-6 space-y-6">
      <div>
        ...
        <div className="space-y-4 bg-surface-50 dark:bg-surface-950 rounded-lg p-4">
          <div>
      ...
      <div>
        ...
        <div className="space-y-4">
          {dpnsUsernames.length > 0 ? (
            <div className="bg-surface-50 dark:bg-surface-950 rounded-lg p-4">
      ...
      <div>
        ...
        >
          <div className="relative">
            ...
            <label
              htmlFor="theme-light"
              className="flex flex-col items-center gap-2 p-4 rounded-lg border-2 cursor-pointer transition-all peer-data-[state=checked]:border-yappr-500 peer-data-[state=checked]:bg-yappr-50 dark:peer-data-[state=checked]:bg-yappr-950/20 border-surface-200 dark:border-surface-800 hover:bg-surface-50 dark:hover:bg-surface-950"
            >
      ...
      <div className="border-t border-surface-200 dark:border-surface-800 pt-6">
        ...
        <div>
          ...
          <select
            ...
            className="w-full p-3 rounded-lg border border-surface-200 dark:border-surface-800 bg-white dark:bg-surface-950 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-yappr-500"
          >
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="bg-surface-50 dark:bg-surface-900 rounded-lg p-4">
        ...
        <ul className="space-y-2 text-sm text-surface-500 dark:text-surface-400">
          ...
          <li className="flex gap-2">
            <span className="text-yappr-500">&bull;</span>
            Posts reference images using <code className="text-xs bg-surface-100 dark:bg-surface-800 px-1 rounded">ipfs://CID</code> URLs
          </li>
          <li className="flex gap-2">
            <span className="text-yappr-500">&bull;</span>
  ...
  const renderAboutSettings = () => {
    ...
    <div className="p-6 space-y-6">
      ...
      {/* Build Information */}
      <div className="bg-surface-50 dark:bg-surface-900 rounded-lg p-4 space-y-2">
