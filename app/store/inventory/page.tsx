...
function InventoryPage() {
    ...
    return (
      <div className="min-h-[calc(100vh-40px)] flex">
        ...
        <div className="flex-1 flex justify-center min-w-0">
          <main className="w-full max-w-[900px] md:border-x border-surface-200 dark:border-surface-800 flex items-center justify-center">
            <Spinner />
          </main>
        </div>
        <RightSidebar />
  ...
  return (
    <div className="min-h-[calc(100vh-40px)] flex">
      ...
      <div className="flex-1 flex justify-center min-w-0">
        <main className="w-full max-w-[900px] md:border-x border-surface-200 dark:border-surface-800">
