              ...
              <div className="md:hidden">
                <DropdownMenu.Root>
                  <DropdownMenu.Trigger asChild>
                    <button
                      className="flex items-center gap-2 px-3 py-2 text-sm font-medium rounded-full bg-surface-1 dark:bg-surface-2 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors"
          ...
          <div className="divide-y divide-border">
            {filteredNotifications.map((notification) => (
              <motion.div
                ...
                className={`p-4 hover:bg-surface-1 dark:hover:bg-surface-2 transition-colors cursor-pointer ${
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-3">
                      <Link
                        ...
                        className="h-10 w-10 rounded-full overflow-hidden bg-white dark:bg-surface-0 flex-shrink-0"
                      >
                        ...
                        {(() => {
                          ...
                          return postUrl && post ? (
                            <Link
                              href={postUrl}
                              onClick={(e) => e.stopPropagation()}
                              className="mt-2 p-3 bg-surface-1 dark:bg-surface-2 rounded-lg block text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-800 transition-colors line-clamp-3"
                            >
                              {post.content}
                            </Link>
                          ) : null
