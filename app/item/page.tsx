      ...
      <div className="flex-1 flex justify-center min-w-0">
        <main className="w-full max-w-[700px] md:border-x border-surface-200 dark:border-surface-800">
          ...
          <div className="p-4 space-y-4">
            ...
            <p className="text-2xl font-display font-bold text-yappr-600">
                            ...
                            className={`px-4 py-2 rounded-lg border text-sm font-medium transition-colors ${
                              isSelected
                                ...
                                : isAvailable
                                  ...
                                  : 'border-surface-200 dark:border-surface-700 opacity-40 cursor-not-allowed line-through'
                            }`}
                          >
                            {option}
                          </button>
            ...
            {item.tags && item.tags.length > 0 && (
              <div className="flex flex-wrap gap-2 pt-4">
                {item.tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-3 py-1 bg-surface-100 dark:bg-surface-800 rounded-full text-sm text-surface-500 dark:text-surface-400"
                  >
                    {tag}
                  </span>
                ))}
