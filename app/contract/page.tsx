        ...
        >
          ...
          <div className="p-8">
            <div className="flex items-center justify-between mb-6">
              ...
              <button
                onClick={handleCopy}
                className="flex items-center gap-2 px-4 py-2 bg-surface-100 dark:bg-surface-800 hover:bg-gray-200 dark:hover:bg-surface-800 rounded-lg transition-colors"
              >
                {copied ? (
                  <>
            ...
            <div className="mt-8 grid md:grid-cols-2 gap-6">
              <div className="bg-surface-50 dark:bg-surface-950 rounded-lg p-6">
