  ...
  return (
    <div className="min-h-[calc(100vh-40px)] flex">
      ...
      <div className="flex-1 flex justify-center min-w-0">
        ...
        <header className={`sticky top-[32px] sm:top-[40px] z-40 bg-surface-0/80 dark:bg-surface-3/80 ${potatoMode ? '' : 'backdrop-blur-xl'}`}>
          <div className="px-4 py-3 flex items-center justify-between">
            ...
            <button
              ...
              className="p-2 rounded-full hover:bg-surface-1 dark:hover:bg-surface-2 transition-colors"
            >
        ...
        <div className="border-b border-border px-4 py-2 md:p-4">
          {user ? (
            <div className="flex gap-3">
              <div className="h-10 w-10 md:h-12 md:w-12 rounded-full overflow-hidden bg-surface-0 dark:bg-surface-3 flex-shrink-0">
                {isHydrated ? (
              ...
              <button
                ...
                className="flex-1 text-left px-4 py-3 bg-surface-1 dark:bg-surface-2 rounded-full text-gray-500 hover:bg-surface-1 dark:hover:bg-surface-2 transition-colors"
              >
                What&apos;s happening?
              </button>
            </div>
        ...
        {activeTab === 'following' && !user ? (
          <div className="flex flex-col items-center justify-center py-16 px-4">
            <div className="w-16 h-16 bg-surface-1 dark:bg-surface-2 rounded-full flex items-center justify-center mb-4">
        ...
        <ErrorBoundary level="component">
          ...
          {pendingNewPosts.length > 0 && (
            <button
              ...
              className="w-full py-3 text-center text-yappr-500 hover:bg-yappr-50 dark:hover:bg-yappr-900/20 font-medium transition-colors border-b border-border"
            >
              ...
              {hasMore && filteredPosts && filteredPosts.length > 0 && (
                <div className="p-4 flex justify-center border-t border-border">
                  <button
                    ...
                    className="px-6 py-2 rounded-full bg-gradient-yappr text-white hover:opacity-90 disabled:opacity-50 transition-colors"
                  >
