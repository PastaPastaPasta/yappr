            ...
            <div className="flex items-center gap-4 p-4">
              ...
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full h-12 pl-12 pr-4 bg-surface-1 dark:bg-surface-2 rounded-full focus:outline-none focus:ring-2 focus:ring-yappr-500 focus:bg-transparent dark:focus:bg-transparent"
                />
              </div>
            </div>
          </header>
                    ...
                    trendingHashtags.map((trend, index) => {
                      ...
                      return (
                        <motion.div
                          ...
                          className="w-full p-4 hover:bg-surface-1 dark:hover:bg-surface-2 transition-colors text-left cursor-pointer"
                        >
