...
function FlowBox({
  ...
  return (
    <div className="my-4 border border-surface-200 dark:border-surface-700 rounded-lg overflow-hidden">
      ...
      <div className="p-4">
        <ol className="space-y-2">
          {steps.map((step, i) => (
            <li key={i} className="flex gap-3">
              <span className="flex-shrink-0 w-6 h-6 rounded-full bg-surface-100 dark:bg-surface-800 text-surface-500 dark:text-surface-400 text-sm flex items-center justify-center">
                {i + 1}
              </span>
        ...
        {note && (
          <p className="mt-4 pt-3 border-t border-surface-200 dark:border-surface-700 text-sm text-gray-500 dark:text-gray-500">
            {note}
          </p>
        )}
      </div>
...
function Section({
  ...
  return (
    <section className="scroll-mt-8" id={sectionId}>
      ...
      <div className="text-surface-500 dark:text-surface-400 leading-relaxed space-y-4">
        {children}
      </div>
    </section>
  )
        ...
        >
          ...
          <div className="p-8 space-y-10">
                ...
                <table className="w-full text-sm border-collapse">
                  <thead>
                    <tr className="bg-surface-100 dark:bg-surface-800">
                      <th className="text-left p-3 font-semibold border border-surface-200 dark:border-surface-700">Approach</th>
                      <th className="text-left p-3 font-semibold border border-surface-200 dark:border-surface-700">Post Cost</th>
                      <th className="text-left p-3 font-semibold border border-surface-200 dark:border-surface-700">Revoke Cost</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="p-3 border border-surface-200 dark:border-surface-700">Encrypt per-follower</td>
                      <td className="p-3 border border-surface-200 dark:border-surface-700 font-mono text-red-600 dark:text-red-400">O(N)</td>
                      <td className="p-3 border border-surface-200 dark:border-surface-700 font-mono">O(1)</td>
                    </tr>
                    <tr className="bg-surface-50 dark:bg-surface-900">
                      <td className="p-3 border border-surface-200 dark:border-surface-700">Share one key</td>
                      <td className="p-3 border border-surface-200 dark:border-surface-700 font-mono">O(1)</td>
                      <td className="p-3 border border-surface-200 dark:border-surface-700 font-mono text-red-600 dark:text-red-400">O(N) or impossible</td>
                    </tr>
                    <tr>
                      <td className="p-3 border border-surface-200 dark:border-surface-700">Re-encrypt on revoke</td>
                      <td className="p-3 border border-surface-200 dark:border-surface-700 font-mono">O(1)</td>
                      <td className="p-3 border border-surface-200 dark:border-surface-700 font-mono text-red-600 dark:text-red-400">O(posts × N)</td>
                    </tr>
                    <tr className="bg-green-50 dark:bg-green-950/30">
                      <td className="p-3 border border-surface-200 dark:border-surface-700 font-semibold text-green-700 dark:text-green-300">What we need</td>
                      <td className="p-3 border border-surface-200 dark:border-surface-700 font-mono font-semibold text-green-700 dark:text-green-300">O(1)</td>
                      <td className="p-3 border border-surface-200 dark:border-surface-700 font-mono font-semibold text-green-700 dark:text-green-300">O(log N)</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <Section title="The Key Tree Structure">
              ...
              <div className="my-6 p-6 bg-surface-50 dark:bg-surface-950 rounded-xl border border-surface-200 dark:border-surface-800">
                ...
                <p className="text-sm text-surface-500 dark:text-surface-400 mt-2 text-center">Binary key tree structure with 1,024 leaf slots</p>
              </div>
              ...
              <div className="my-6 p-6 bg-surface-50 dark:bg-surface-950 rounded-xl border border-surface-200 dark:border-surface-800">
                ...
                <div className="relative ml-4">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4 relative pl-8">
                      <div className="relative z-10 px-4 py-2 bg-surface-200 dark:bg-surface-700 text-gray-700 dark:text-gray-200 rounded-lg text-sm font-medium min-w-[85px] text-center">
                        Node C
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 relative pl-12">
                      <div className="relative z-10 px-4 py-1 text-surface-400 dark:text-surface-500 text-lg font-bold">
                        ...
                      </div>
                    </div>
                ...
                <div className="mt-6 pt-4 border-t border-surface-200 dark:border-surface-700">
                  <p className="text-sm text-red-600 dark:text-red-400">
                    <strong>Alice does NOT know:</strong> <span className="text-surface-500 dark:text-surface-400">Node B, Node D, Node E, etc. (these are on other followers&apos; paths)</span>
                  </p>
                </div>
              </div>
            ...
            <Section icon={ArrowPathIcon} title="Epochs: Forward Secrecy Through Time">
              ...
              {/* Hash Chain Diagram */}
              <div className="my-6 p-6 bg-surface-50 dark:bg-surface-950 rounded-xl border border-surface-200 dark:border-surface-800">
                <h4 className="text-xs font-bold uppercase tracking-wider text-center text-surface-500 dark:text-surface-400 mb-6">Hash Chain</h4>
                <div className="flex flex-col items-center">
                  {/* CEK[2000] */}
                  <div className="flex items-center gap-4">
                    <div className="px-4 py-2 bg-surface-200 dark:bg-surface-800 text-surface-500 dark:text-surface-400 rounded-lg font-mono text-sm">
                      CEK[2000]
                    </div>
                    <span className="text-xs text-surface-400 dark:text-surface-500">Pre-generated at setup</span>
                  </div>

                  {/* Arrow with SHA256 */}
                  <div className="flex flex-col items-center my-2">
                    <div className="w-0.5 h-3 bg-gray-300 dark:bg-gray-600" />
                    <div className="px-2 py-0.5 bg-surface-100 dark:bg-surface-800 rounded text-xs text-surface-500 dark:text-surface-400 font-mono">SHA256</div>
                    <div className="text-surface-400 dark:text-surface-500 text-lg leading-none">↓</div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-xs text-surface-400 dark:text-surface-500">= SHA256(CEK[2000])</span>
                  </div>
                  ...
                  {/* Dots */}
                  <div className="text-surface-400 dark:text-surface-500 text-2xl tracking-widest my-1">⋮</div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <span className="text-xs text-surface-500 dark:text-surface-400">After first revocation</span>
                  </div>
                ...
                <div className="mt-6 pt-4 border-t border-surface-200 dark:border-surface-700 space-y-3">
            ...
            <Section title="Revocation: The Elegant Part">
              ...
              <div className="my-6 grid md:grid-cols-2 gap-4">
                {/* Before */}
                <div className="p-5 bg-surface-50 dark:bg-surface-950 rounded-xl border border-surface-200 dark:border-surface-800">
                  <div className="text-center mb-4">
                    <h4 className="text-xs font-bold uppercase tracking-wider text-surface-500 dark:text-surface-400">Before Revocation</h4>
                    <p className="text-xs text-surface-400 dark:text-surface-500 mt-1">(Epoch 1)</p>
                  </div>
              ...
              {/* Rekey Packets */}
              <div className="my-6 border border-surface-200 dark:border-surface-700 rounded-lg overflow-hidden">
                ...
                <div className="p-4 space-y-3">
                  {[
                    ...
                    {
                      packet: 3,
                      content: <><code className="text-xs bg-green-100 dark:bg-green-900 px-1 rounded">new_Root_v2</code> encrypted under <code className="text-xs bg-surface-200 dark:bg-surface-700 px-1 rounded">old_Node3_v1</code></>,
                      who: 'Carol',
                    ...
                    <div key={item.packet} className="flex gap-3 p-3 bg-surface-50 dark:bg-surface-900 rounded-lg">
                      <div className="flex-shrink-0 w-8 h-8 rounded-full bg-surface-200 dark:bg-surface-700 flex items-center justify-center text-sm font-medium">
                        {item.packet}
                      </div>
                ...
                <div className="px-4 py-3 bg-red-50 dark:bg-red-950/30 border-t border-surface-200 dark:border-surface-700">
            ...
            <Section icon={CpuChipIcon} title="Under the Hood">
              <SubSection title="What Gets Written to the Chain?">
                ...
                <ul className="space-y-3 mt-4">
                  <li className="bg-surface-50 dark:bg-surface-950 rounded-lg p-4">
              ...
              <SubSection title="Cryptographic Primitives">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse">
                    <thead>
                      <tr className="bg-surface-100 dark:bg-surface-800">
                        <th className="text-left p-3 font-semibold border border-surface-200 dark:border-surface-700">Purpose</th>
                        <th className="text-left p-3 font-semibold border border-surface-200 dark:border-surface-700">Algorithm</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="p-3 border border-surface-200 dark:border-surface-700 align-top">Content encryption</td>
                        <td className="p-3 border border-surface-200 dark:border-surface-700">
                      ...
                      <tr className="bg-surface-50 dark:bg-surface-900">
                        <td className="p-3 border border-surface-200 dark:border-surface-700 align-top">Key derivation</td>
                        <td className="p-3 border border-surface-200 dark:border-surface-700">
                      ...
                      <tr>
                        <td className="p-3 border border-surface-200 dark:border-surface-700 align-top">Epoch chain</td>
                        <td className="p-3 border border-surface-200 dark:border-surface-700">
                      ...
                      <tr className="bg-surface-50 dark:bg-surface-900">
                        <td className="p-3 border border-surface-200 dark:border-surface-700 align-top">Key exchange</td>
                        <td className="p-3 border border-surface-200 dark:border-surface-700">
              ...
              <SubSection title="Capacity Limits">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm border-collapse">
                    <thead>
                      <tr className="bg-surface-100 dark:bg-surface-800">
                        <th className="text-left p-3 font-semibold border border-surface-200 dark:border-surface-700">Limit</th>
                        <th className="text-left p-3 font-semibold border border-surface-200 dark:border-surface-700">Value</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        <td className="p-3 border border-surface-200 dark:border-surface-700">Maximum private followers</td>
                        <td className="p-3 border border-surface-200 dark:border-surface-700 font-mono">1,024</td>
                      </tr>
                      <tr className="bg-surface-50 dark:bg-surface-900">
                        <td className="p-3 border border-surface-200 dark:border-surface-700">Maximum epochs (revocations)</td>
                        <td className="p-3 border border-surface-200 dark:border-surface-700 font-mono">2,000</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-surface-200 dark:border-surface-700">Rekey packets per revocation</td>
                        <td className="p-3 border border-surface-200 dark:border-surface-700 font-mono">~20</td>
                      </tr>
                      <tr className="bg-surface-50 dark:bg-surface-900">
                        <td className="p-3 border border-surface-200 dark:border-surface-700">Grant document size</td>
                        <td className="p-3 border border-surface-200 dark:border-surface-700 font-mono">~500 bytes</td>
                      </tr>
                      <tr>
                        <td className="p-3 border border-surface-200 dark:border-surface-700">Rekey document size</td>
                        <td className="p-3 border border-surface-200 dark:border-surface-700 font-mono">~1-2 KB</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
            ...
            <div className="pt-6 border-t border-surface-200 dark:border-surface-800">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <a
                  ...
                  className="block bg-surface-50 dark:bg-surface-950 rounded-lg p-4 hover:bg-surface-100 dark:hover:bg-surface-800 transition-colors"
                >
