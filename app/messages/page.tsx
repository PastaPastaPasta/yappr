...
function MessagesPage() {
  ...
  return (
    <div className="h-[calc(100dvh-32px-56px)] md:h-[calc(100dvh-40px)] flex overflow-hidden">
      ...
      <main className="flex-1 md:max-w-[1200px] md:border-x border-surface-200 dark:border-neutral-750 flex overflow-hidden">
        {/* Conversations List */}
        <div className={`w-full md:w-[320px] lg:w-[380px] xl:w-[400px] border-r border-surface-200 dark:border-neutral-750 flex flex-col flex-shrink-0 overflow-hidden ${selectedConversation ? 'hidden md:flex' : 'flex'}`}>
          <header className="flex-shrink-0 bg-white dark:bg-surface-900 border-b border-surface-200 dark:border-neutral-750">
              ...
              {filteredConversations.map((conversation) => (
                <button
                  ...
                  className={`w-full p-3 sm:p-4 hover:bg-gray-50 dark:hover:bg-gray-950 transition-colors flex gap-3 ${
                    selectedConversation?.id === conversation.id ? 'bg-surface-100 dark:bg-surface-800' : ''
                  }`}
                >
        ...
        {selectedConversation ? (
          <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
            <header className="flex-shrink-0 bg-white dark:bg-surface-900 border-b border-surface-200 dark:border-neutral-750 px-2 sm:px-4 py-2 sm:py-3">
            ...
            <div className="flex-shrink-0 border-t border-surface-200 dark:border-neutral-750 p-2 sm:p-4 safe-area-inset-bottom">
              <form
                onSubmit={(e) => {
                  e.preventDefault()
          ...
          <div className="relative bg-white dark:bg-surface-900 rounded-2xl w-full max-w-md mx-3 sm:mx-4 p-4 sm:p-6 shadow-xl max-h-[80vh] overflow-y-auto">
            ...
            >
              ...
              {(isSearchingUsers || userSearchResults.length > 0) && (
                <div className="mb-4 border border-surface-200 dark:border-neutral-750 rounded-xl overflow-hidden">
                  {isSearchingUsers ? (
                    ...
                    <div className="max-h-64 overflow-y-auto">
                      {userSearchResults.map((result) => (
                        <button
                          ...
                          disabled={isResolvingUser}
                          className="w-full flex items-center gap-3 p-3 hover:bg-surface-100 dark:hover:bg-surface-800 transition-colors text-left border-b border-surface-200 dark:border-neutral-750 last:border-b-0"
                        >
              ...
              {!isSearchingUsers && userSearchResults.length === 0 && newConversationInput.trim().length >= 3 && newConversationInput.trim().length <= 30 && (
                <div className="mb-4 p-3 text-center text-sm text-gray-500 border border-surface-200 dark:border-neutral-750 rounded-xl">
