...
The deployed social contract (`contracts/yappr-social-contract-v2.json` on staging/prod; the /devnet build runs the v7 contract, `contracts/yappr-social-contract-v7.json`) defines 16 document types:
