...
export const YAPPR_VAULT_CONTRACT_ID = process.env.NEXT_PUBLIC_YAPPR_VAULT_CONTRACT_ID || 'GjifTJzXowSQ527JeQUPaMCrrqHdzUT25hAEqKiFdHYx' // Testnet - Vault contract (contract-bound encryption keys + encrypted storage)
