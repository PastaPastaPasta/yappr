...
export const YAPPR_VAULT_CONTRACT_ID = process.env.NEXT_PUBLIC_YAPPR_VAULT_CONTRACT_ID || 'DhavcWdHgscAvo7U8a232zEfnWqfN2X1AGcFykkxFRFU' // Testnet - Vault contract (contract-bound encryption keys + encrypted storage)
