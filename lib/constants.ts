...
export const YAPPR_VAULT_CONTRACT_ID = 'GjifTJzXowSQ527JeQUPaMCrrqHdzUT25hAEqKiFdHYx' // Testnet - Vault contract (contract-bound encryption keys + encrypted storage)
