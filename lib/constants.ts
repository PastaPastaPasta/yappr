...
export const KEY_EXCHANGE_CONTRACT_ID = process.env.NEXT_PUBLIC_KEY_EXCHANGE_CONTRACT_ID || 'AqbY1qAo6V7M1xUYeQgMGhZh1mvSLNBpt9t8VQNjktoG' // Key exchange protocol contract v2 (unique byContractAndEphemeralKey index)
